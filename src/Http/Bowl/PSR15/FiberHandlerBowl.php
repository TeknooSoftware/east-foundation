...
/**
 * Recipe bowl to support PSR 15 Request handler into a HTTP recipe. The handler will be executed into a dedicated
 * fiber.
 ...
 * @author      Richard Déloge <richard@teknoo.software>
 */
class FiberHandlerBowl extends FiberBowl
{
    /**
