...
namespace Teknoo\Tests\East\FoundationBundle\Controller;

use Symfony\Component\DependencyInjection\ContainerInterface;
use Symfony\Component\Security\Core\User\UserInterface;
use Teknoo\East\FoundationBundle\Controller\Controller;
 ...
 * @license     http://teknoo.software/license/mit         MIT License
 * @author      Richard Déloge <richarddeloge@gmail.com>
 * @covers \Teknoo\East\FoundationBundle\Controller\Controller
 */
class ControllerBehaviorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $client = $this->createMock('Teknoo\East\Foundation\Http\ClientInterface');
